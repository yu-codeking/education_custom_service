from edu_service.domain.messages import UserMessage, ProcessedResult
...
class DialogueStateService:
    ...
    async def load_state(self, sender_id: str,
        ...
        if ensure and dialogue_state.current_session_id is None and not dialogue_state.sessions:
            if user_id:
